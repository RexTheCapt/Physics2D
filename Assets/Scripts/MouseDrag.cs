...
namespace Assets.Scripts
{
    public class MouseDrag : MonoBehaviour
    {
        ...
        private bool DisableDrag;                                                   // A boolean to disable dragging if something happens.
        ...
        void OnMouseDown()
        {
            if (isDraggable)                                                        // If object is draggable then run this block.
            {
                ...
                DisableDrag = false;                                                // Make sure value is true.
            }
        }
        ...
        void OnMouseDrag()
        {
            if (!DisableDrag && isDraggable)                                        // Check if object can be dragged.
            {
        ...
        {
            if (!DisableDrag)                                                       // Check if value is false.
